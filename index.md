...
**Timeline:**
- IRB approval: January 2026
- Recruitment & pilot: January 2026
- Data collection: February 2026
- Analysis & publication: March-April 2026

Full results will be published separately as HRI-focused paper.

---

## <a name="reproducibility"></a>💾 Reproducibility & Code

### Prerequisites

```bash
# Install CoppeliaSim
wget https://coppeliarobotics.com/files/CoppeliaSim_Edu_V4.6.0_rev22_Ubuntu20_04.tar.xz
tar -xf CoppeliaSim_Edu_V4.6.0_rev22_Ubuntu20_04.tar.xz

# Install Python packages
pip install coppeliasim-python-api matplotlib numpy scipy pandas
```

### Clone Repository

```bash
git clone https://github.com/your-username/hri-2026-research.git
cd hri-2026-research
```

### Run Baseline Experiments

```bash
# Run 20 trials on all paths
python simulate.py --method baseline --trials 20 --verbose
...
```bash
# Run 20 trials on all paths
python simulate.py --method ours --trials 20 --verbose

# Output: results/system_results.csv
```
...
```bash
# Analyze results
python analyze.py --baseline results/baseline_results.csv \
                  --system results/system_results.csv \
                  --output results/comparison_analysis.json

# Generate plots
python plot_results.py --analysis results/comparison_analysis.json \
                       --output figures/

# Output: figures/success_rate.png, figures/failure_breakdown.png, etc.
```
...
├── coppeliasim_scenes/               # .ttt scene files
│   ├── path_a_easy.ttt
│   ├── path_b_medium.ttt
│   ├── path_c_medium_plus.ttt
│   ├── path_d_hard.ttt
│   └── path_e_very_hard.ttt
├── src/                               # Source code
│   ├── perception.py                 # Perception pipeline
│   ├── planning.py                   # S-MPC planner
│   ├── supervisor.py                 # Failure detection
│   └── communication.py              # Human alerts
...
<!-- [LINK PLACEHOLDER: Link to GitHub README with detailed instructions] -->
[See GitHub Repository for complete documentation](https://github.com/your-username/hri-2026-research)

### Data & Code Availability

- **GitHub Repository:** [link to your-username/hri-2026-research]
- **Simulation Scenes:** Available in `coppeliasim_scenes/` directory
- **Raw Data:** All 300 simulation logs available in `results/` directory
- **Analysis Scripts:** Reproducible analysis in `src/` directory

### Reproducibility Checklist

- [ ] CoppeliaSim installed and working
- [ ] Python packages installed via requirements.txt
- [ ] GitHub repo cloned
- [ ] Baseline simulation runs successfully
- [ ] Your system simulation runs successfully
- [ ] Analysis scripts generate results
- [ ] Plots generated match expected figures
...
```bibtex
@article{2025_hri_resilient_multirobots,
  title={Keeping the Team Moving: Resilient Multi-Robot Coordination 
